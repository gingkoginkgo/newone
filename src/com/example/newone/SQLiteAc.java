...
public class SQLiteAc extends SQLiteOpenHelper{
	...
	public void incert(String desc, String sTime, String dLine, float pri, String action, String tPlace){
	...
	public Cursor getdatas(){
		...
		Cursor cursor = db.query(dbName, columns, null, null, null, null, "sTime");
        return cursor;
	}
